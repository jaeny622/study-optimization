		...
		const callback = (entries, observer) => {
			entries.forEach((entry) => {
				if(entry.isIntersecting) {
					const srcEl = entry.target.previousSibling;
				...
				<TwoColumns
					...
					columns={[
						<picture>
							...
							<img data-src={main_items} ref={el=>imgRef.current[0] = el}/>
						</picture>,
						<Meta
							title={'Items'}
				...
				<TwoColumns
					...
					columns={[
						...
						<picture>
							...
							<img data-src={main_parts} ref={el=>imgRef.current[1] = el}/>
						</picture>
					]}
					mobileReverse={true}
				/>
				<TwoColumns
					...
					columns={[
						<picture>
							...
							<img data-src={main_styles} ref={el=>imgRef.current[2] = el}/>
						</picture>,
						<Meta
							title={'Riding Styles'}
